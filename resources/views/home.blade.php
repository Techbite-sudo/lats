            ...
            <div class="card border-0 shadow-lg">
                <div class="card-header border-0 bg-transparent mb-2 fs-2 text-primary lead">
                    <div class="d-flex justify-content-between">
                        ...
                        <div class="col-5">
                            <input type="search" id="searchUsers" class="form-control shadow-none rounded-0" placeholder="Type anything to search">
                        </div>
                        <div class="col-3">
                            <button type="button" class="excelUsers btn btn-primary rounded-0 shadow-none">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="{{ route('users.destroy', ['id' => $user->id]) }}" class="btn btn-outline-danger shadow-none rounded-circle">
            ...
            <div class="card border-0 shadow-lg">
                <div class="card-header border-0 bg-transparent mb-2 fs-2 text-primary lead">
                    <div class="d-flex justify-content-between">
                        ...
                        <div class="col-5">
                            <input type="search" id="searchExamsStudent" class="form-control shadow-none rounded-0" placeholder="Type anything to search">
                        </div>
                        <div class="col-3">
                            <button type="button" class="excelExamsStudent btn btn-primary rounded-0 shadow-none">
                                <span class="me-2"><i class=" fa-solid fa-file-excel"></i></span>
                                {{ __('Export Excel ') }}
                            </button>
                        </div>
